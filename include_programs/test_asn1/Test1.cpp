...
namespace Test1 {
    ...
    PersonnelRecord_impl::PersonnelRecord_impl(boost::shared_ptr< Name>  arg__name,
        ...
        const Name& PersonnelRecord_impl::name() const { return *name_ ;}

        void PersonnelRecord_impl::name( const Name& vl){ name_ =vl ;}

        void PersonnelRecord_impl::name( boost::shared_ptr< Name>  vl){ name_ =vl ;}


        visiblestring_type& PersonnelRecord_impl::title(){ return *title_ ;}

        const visiblestring_type& PersonnelRecord_impl::title() const { return *title_ ;}

        void PersonnelRecord_impl::title( const visiblestring_type& vl){ title_ =vl ;}

        void PersonnelRecord_impl::title( boost::shared_ptr< visiblestring_type>  vl){ title_ =vl ;}


        EmployeeNumber& PersonnelRecord_impl::number(){ return *number_ ;}

        const EmployeeNumber& PersonnelRecord_impl::number() const { return *number_ ;}

        void PersonnelRecord_impl::number( const EmployeeNumber& vl){ number_ =vl ;}

        void PersonnelRecord_impl::number( boost::shared_ptr< EmployeeNumber>  vl){ number_ =vl ;}


        Date& PersonnelRecord_impl::dateOfHire(){ return *dateOfHire_ ;}

        const Date& PersonnelRecord_impl::dateOfHire() const { return *dateOfHire_ ;}

        void PersonnelRecord_impl::dateOfHire( const Date& vl){ dateOfHire_ =vl ;}

        void PersonnelRecord_impl::dateOfHire( boost::shared_ptr< Date>  vl){ dateOfHire_ =vl ;}


        Name& PersonnelRecord_impl::nameOfSpouse(){ return *nameOfSpouse_ ;}

        const Name& PersonnelRecord_impl::nameOfSpouse() const { return *nameOfSpouse_ ;}

        void PersonnelRecord_impl::nameOfSpouse( const Name& vl){ nameOfSpouse_ =vl ;}

        void PersonnelRecord_impl::nameOfSpouse( boost::shared_ptr< Name>  vl){ nameOfSpouse_ =vl ;}


        boost::shared_ptr<PersonnelRecord_impl::Children_type> PersonnelRecord_impl::children__new (){ return children_ = boost::shared_ptr<Children_type>(new Children_type()) ;}

        void PersonnelRecord_impl::children( const Children_type& vl){ children_ = boost::shared_ptr<Children_type>(new Children_type(vl)) ;}
    ...
    ChildInformation::ChildInformation(const Name&  arg__name,
        ...
        void ChildInformation::name( const Name& vl){ name_ =vl ;}

        void ChildInformation::name( boost::shared_ptr< Name>  vl){ name_ =vl ;}


        Date& ChildInformation::dateOfBirth(){ return *dateOfBirth_ ;}

        const Date& ChildInformation::dateOfBirth() const { return *dateOfBirth_ ;}

        void ChildInformation::dateOfBirth( const Date& vl){ dateOfBirth_ =vl ;}

        void ChildInformation::dateOfBirth( boost::shared_ptr< Date>  vl){ dateOfBirth_ =vl ;}
