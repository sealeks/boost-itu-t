...
namespace MMS_Environment_1 {
    ...
    ApplicationReference::ApplicationReference(boost::shared_ptr< ACSE_1::AP_title> __ap_title,
    ...
    ap_title_(__ap_title),
    ap_invocation_id_(__ap_invocation_id),
    ae_qualifier_(__ae_qualifier),
    ae_invocation_id_(__ae_invocation_id) {
    };
