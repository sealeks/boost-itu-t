...
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::VMD_File::selected_Program_Invocation_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Access_Control_List_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Domain_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Program_Invocation_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Unit_Control_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Named_Variable_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Named_Variable_List_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Named_Type_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Data_Exchange_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Semaphore_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Operator_Station_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Condition_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Condition_instance::definition_type::details_type::monitoredVariable_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Condition_instance::definition_type::details_type::displayEnhancement_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Condition_instance::definition_type::details_type::group_Priority_Override_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Action_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Enrollment_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Enrollment_instance::definition_type::details_type::remainingDelay_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Enrollment_instance::definition_type::details_type::displayEnhancement_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Event_Condition_List_instance::definition_type) 
BOOST_ASN_CHOISE_REGESTRATE(MMS_SCI_Module_1::Journal_instance::definition_type) 
