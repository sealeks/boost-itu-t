...
namespace MMS_Object_Module_1 {
    ...
    ModifierStep::ModifierStep(const int& __modifierID,
            const Modifier& __modifier) :
    modifierID_(__modifierID),
    modifier_(__modifier) {
    };
    ...
    template<> void Modifier::serialize(boost::asn1::x690::output_coder& arch) {
        switch (type()) {
            ...
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::AttachToEventCondition > (false, Modifier_eventModifier), 0);
                break;
            }
            case Modifier_semaphoreModifier:
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::AttachToSemaphore > (false, Modifier_semaphoreModifier), 1);
                break;
            }
            default:
            {
        ...
        switch (arch.test_class()) {
            ...
            case 0x80:
            {
                switch (__tag_id__) {
                    case 0:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::AttachToEventCondition > (true, Modifier_eventModifier), 0)) return;
                        else free();
                        break;
                    }
                    case 1:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::AttachToSemaphore > (true, Modifier_semaphoreModifier), 1)) return;
                        else free();
                        break;
                    }
                    default:
    ...
    template<> void AccessCondition::user_type::serialize(boost::asn1::x690::output_coder& arch) {
        switch (type()) {
            ...
            {
                BOOST_ASN_BIND_TAG(value<MMS_Environment_1::ApplicationReference > (false, user_type_association));
                break;
            }
            case user_type_none:
            {
                BOOST_ASN_BIND_TAG(value<null_type > (false, user_type_none));
                break;
            }
            default:
            {
    ...
    template<> void AccessCondition::user_type::serialize(boost::asn1::x690::input_coder& arch) {
        ...
        switch (arch.test_class()) {
            ...
            default:
            {
                if (BOOST_ASN_BIND_TAG(value<MMS_Environment_1::ApplicationReference > (true, user_type_association))) return;
                else free();
                if (BOOST_ASN_BIND_TAG(value<null_type > (true, user_type_none))) return;
                else free();
            }
        }
    }
    ...
    template<> void AccessCondition::serialize(boost::asn1::x690::output_coder& arch) {
        switch (type()) {
            ...
            {
                BOOST_ASN_IMPLICIT_TAG(value<null_type > (false, AccessCondition_never), 0);
                break;
            }
            case AccessCondition_semaphore:
            {
                BOOST_ASN_EXPLICIT_TAG(value<ISO_9506_MMS_1::Identifier > (false, AccessCondition_semaphore), 1);
                break;
            }
            case AccessCondition_user:
            {
                BOOST_ASN_CHOICE_TAG(value<user_type > (false, AccessCondition_user), 2);
                break;
            }
            case AccessCondition_password:
            {
                BOOST_ASN_CHOICE_TAG(value<ACSE_1::Authentication_value > (false, AccessCondition_password), 3);
                break;
            }
            case AccessCondition_joint:
            {
                BOOST_ASN_IMPLICIT_TAG(value<joint_type > (false, AccessCondition_joint), 4);
                break;
            }
            case AccessCondition_alternate:
            {
                BOOST_ASN_IMPLICIT_TAG(value<alternate_type > (false, AccessCondition_alternate), 5);
                break;
            }
            default:
            {
        ...
        switch (arch.test_class()) {
            ...
            case 0x80:
            {
                switch (__tag_id__) {
                    case 0:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<null_type > (true, AccessCondition_never), 0)) return;
                        else free();
                        break;
                    }
                    case 1:
                    {
                        if (BOOST_ASN_EXPLICIT_TAG(value<ISO_9506_MMS_1::Identifier > (true, AccessCondition_semaphore), 1)) return;
                        else free();
                        break;
                    }
                    case 2:
                    {
                        if (BOOST_ASN_CHOICE_TAG(value<user_type > (true, AccessCondition_user), 2)) return;
                        else free();
                        break;
                    }
                    case 3:
                    {
                        if (BOOST_ASN_CHOICE_TAG(value<ACSE_1::Authentication_value > (true, AccessCondition_password), 3)) return;
                        else free();
                        break;
                    }
                    case 4:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<joint_type > (true, AccessCondition_joint), 4)) return;
                        else free();
                        break;
                    }
                    case 5:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<alternate_type > (true, AccessCondition_alternate), 5)) return;
                        else free();
                        break;
                    }
                    default:
    ...
    template<> void Address::serialize(boost::asn1::x690::output_coder& arch) {
        switch (type()) {
            ...
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned32 > (false, Address_numericAddress), 0);
                break;
            }
            case Address_symbolicAddress:
            {
                BOOST_ASN_EXPLICIT_TAG(value<ISO_9506_MMS_1::MMSString > (false, Address_symbolicAddress), 1);
                break;
            }
            case Address_unconstrainedAddress:
            {
                BOOST_ASN_IMPLICIT_TAG(value<octetstring_type > (false, Address_unconstrainedAddress), 2);
                break;
            }
            default:
            {
        ...
        switch (arch.test_class()) {
            ...
            case 0x80:
            {
                switch (__tag_id__) {
                    case 0:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned32 > (true, Address_numericAddress), 0)) return;
                        else free();
                        break;
                    }
                    case 1:
                    {
                        if (BOOST_ASN_EXPLICIT_TAG(value<ISO_9506_MMS_1::MMSString > (true, Address_symbolicAddress), 1)) return;
                        else free();
                        break;
                    }
                    case 2:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<octetstring_type > (true, Address_unconstrainedAddress), 2)) return;
                        else free();
                        break;
                    }
                    default:
    ...
    TypeDescription::array_type::array_type(const ISO_9506_MMS_1::Unsigned32& __numberOfElements,
            const ISO_9506_MMS_1::TypeSpecification& __elementType) :
    numberOfElements_(__numberOfElements),
    elementType_(__elementType) {
    };

    TypeDescription::array_type::array_type(boost::shared_ptr< bool> __packed,
    ...
    TypeDescription::structure_type::structure_type(const components_type& __components) :
    components_(__components) {
    };

    TypeDescription::structure_type::structure_type(boost::shared_ptr< bool> __packed,
    ...
    TypeDescription::structure_type::components_type_sequence_of::components_type_sequence_of(const ISO_9506_MMS_1::TypeSpecification& __componentType) :
    componentType_(__componentType) {
    };

    TypeDescription::structure_type::components_type_sequence_of::components_type_sequence_of(boost::shared_ptr< ISO_9506_MMS_1::Identifier> __componentName,
    ...
    TypeDescription::floating_point_type::floating_point_type(const ISO_9506_MMS_1::Unsigned8& __format_width,
            const ISO_9506_MMS_1::Unsigned8& __exponent_width) :
    format_width_(__format_width),
    exponent_width_(__exponent_width) {
    };
    ...
    template<> void TypeDescription::serialize(boost::asn1::x690::output_coder& arch) {
        switch (type()) {
            ...
            {
                BOOST_ASN_IMPLICIT_TAG(value<array_type > (false, TypeDescription_array), 1);
                break;
            }
            case TypeDescription_structure:
            {
                BOOST_ASN_IMPLICIT_TAG(value<structure_type > (false, TypeDescription_structure), 2);
                break;
            }
            case TypeDescription_boolean:
            {
                BOOST_ASN_IMPLICIT_TAG(value<null_type > (false, TypeDescription_boolean), 3);
                break;
            }
            case TypeDescription_bit_string:
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Integer32 > (false, TypeDescription_bit_string), 4);
                break;
            }
            case TypeDescription_integer:
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned8 > (false, TypeDescription_integer), 5);
                break;
            }
            case TypeDescription_unsignedV:
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned8 > (false, TypeDescription_unsignedV), 6);
                break;
            }
            case TypeDescription_floating_point:
            {
                BOOST_ASN_IMPLICIT_TAG(value<floating_point_type > (false, TypeDescription_floating_point), 7);
                break;
            }
            case TypeDescription_octet_string:
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Integer32 > (false, TypeDescription_octet_string), 9);
                break;
            }
            case TypeDescription_visible_string:
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Integer32 > (false, TypeDescription_visible_string), 10);
                break;
            }
            case TypeDescription_generalized_time:
            {
                BOOST_ASN_IMPLICIT_TAG(value<null_type > (false, TypeDescription_generalized_time), 11);
                break;
            }
            case TypeDescription_binary_time:
            {
                BOOST_ASN_IMPLICIT_TAG(value<bool > (false, TypeDescription_binary_time), 12);
                break;
            }
            case TypeDescription_bcd:
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned8 > (false, TypeDescription_bcd), 13);
                break;
            }
            case TypeDescription_objId:
            {
                BOOST_ASN_IMPLICIT_TAG(value<null_type > (false, TypeDescription_objId), 15);
                break;
            }
            case TypeDescription_mMSString:
            {
                BOOST_ASN_EXPLICIT_TAG(value<ISO_9506_MMS_1::Integer32 > (false, TypeDescription_mMSString), 16);
                break;
            }
            default:
            {
        ...
        switch (arch.test_class()) {
            ...
            case 0x80:
            {
                switch (__tag_id__) {
                    case 1:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<array_type > (true, TypeDescription_array), 1)) return;
                        else free();
                        break;
                    }
                    case 2:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<structure_type > (true, TypeDescription_structure), 2)) return;
                        else free();
                        break;
                    }
                    case 3:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<null_type > (true, TypeDescription_boolean), 3)) return;
                        else free();
                        break;
                    }
                    case 4:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Integer32 > (true, TypeDescription_bit_string), 4)) return;
                        else free();
                        break;
                    }
                    case 5:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned8 > (true, TypeDescription_integer), 5)) return;
                        else free();
                        break;
                    }
                    case 6:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned8 > (true, TypeDescription_unsignedV), 6)) return;
                        else free();
                        break;
                    }
                    case 7:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<floating_point_type > (true, TypeDescription_floating_point), 7)) return;
                        else free();
                        break;
                    }
                    case 9:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Integer32 > (true, TypeDescription_octet_string), 9)) return;
                        else free();
                        break;
                    }
                    case 10:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Integer32 > (true, TypeDescription_visible_string), 10)) return;
                        else free();
                        break;
                    }
                    case 11:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<null_type > (true, TypeDescription_generalized_time), 11)) return;
                        else free();
                        break;
                    }
                    case 12:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<bool > (true, TypeDescription_binary_time), 12)) return;
                        else free();
                        break;
                    }
                    case 13:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned8 > (true, TypeDescription_bcd), 13)) return;
                        else free();
                        break;
                    }
                    case 15:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<null_type > (true, TypeDescription_objId), 15)) return;
                        else free();
                        break;
                    }
                    case 16:
                    {
                        if (BOOST_ASN_EXPLICIT_TAG(value<ISO_9506_MMS_1::Integer32 > (true, TypeDescription_mMSString), 16)) return;
                        else free();
                        break;
                    }
                    default:
    ...
    template<> void EventTime::serialize(boost::asn1::x690::output_coder& arch) {
        switch (type()) {
            ...
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::TimeOfDay > (false, EventTime_timeOfDay), 0);
                break;
            }
            case EventTime_timeSequenceIdentifier:
            {
                BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned32 > (false, EventTime_timeSequenceIdentifier), 1);
                break;
            }
            case EventTime_undefined:
            {
                BOOST_ASN_IMPLICIT_TAG(value<null_type > (false, EventTime_undefined), 2);
                break;
            }
            default:
            {
        ...
        switch (arch.test_class()) {
            ...
            case 0x80:
            {
                switch (__tag_id__) {
                    case 0:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::TimeOfDay > (true, EventTime_timeOfDay), 0)) return;
                        else free();
                        break;
                    }
                    case 1:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<ISO_9506_MMS_1::Unsigned32 > (true, EventTime_timeSequenceIdentifier), 1)) return;
                        else free();
                        break;
                    }
                    case 2:
                    {
                        if (BOOST_ASN_IMPLICIT_TAG(value<null_type > (true, EventTime_undefined), 2)) return;
                        else free();
                        break;
                    }
                    default:
    ...
    Journal_Variable::Journal_Variable(const ISO_9506_MMS_1::MMS255String& __variableTag,
