...
namespace ISO_9506_MMS_1 {
    ...
    template<> void MMSpdu::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            case MMSpdu_cancel_RequestPDU:
            {
                ...
                ITU_T_BIND_NUM_CONSTRS(*value<Cancel_RequestPDU > (false, MMSpdu_cancel_RequestPDU), 0, 2147483647);
                break;
            }
            case MMSpdu_cancel_ResponsePDU:
            {
                ITU_T_SET_CONSTAINED_INDX(6, 13);
                ITU_T_BIND_NUM_CONSTRS(*value<Cancel_ResponsePDU > (false, MMSpdu_cancel_ResponsePDU), 0, 2147483647);
                break;
            }
    ...
    template<> void MMSpdu::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 5:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Cancel_RequestPDU > (true, MMSpdu_cancel_RequestPDU), 0, 2147483647);
                break;
            }
            case 6:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Cancel_ResponsePDU > (true, MMSpdu_cancel_ResponsePDU), 0, 2147483647);
                break;
            }
            case 7:
            {
        ...
        if (ITU_T_EXTENTION_CHECK_PER) {
            switch (type()) {
                ...
                case ConfirmedServiceRequest_uploadSegment:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRS(*value<UploadSegment_Request > (false, ConfirmedServiceRequest_uploadSegment), -2147483648, 2147483647);
                    break;
                }
                case ConfirmedServiceRequest_terminateUploadSequence:
                {
                    ITU_T_SET_CONSTAINED_INDX(31, 77);
                    ITU_T_BIND_NUM_CONSTRS(*value<TerminateUploadSequence_Request > (false, ConfirmedServiceRequest_terminateUploadSequence), -2147483648, 2147483647);
                    break;
                }
                ...
                case ConfirmedServiceRequest_fileRead:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRS(*value<ISO_9506_MMS_1A::FileRead_Request > (false, ConfirmedServiceRequest_fileRead), -2147483648, 2147483647);
                    break;
                }
                case ConfirmedServiceRequest_fileClose:
                {
                    ITU_T_SET_CONSTAINED_INDX(74, 77);
                    ITU_T_BIND_NUM_CONSTRS(*value<ISO_9506_MMS_1A::FileClose_Request > (false, ConfirmedServiceRequest_fileClose), -2147483648, 2147483647);
                    break;
                }
    ...
    template<> void ConfirmedServiceRequest::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        if (ITU_T_EXTENTION_CHECK_PER) {
            ...
            switch (__indx__) {
                ...
                case 30:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<UploadSegment_Request > (true, ConfirmedServiceRequest_uploadSegment), -2147483648, 2147483647);
                    break;
                }
                case 31:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<TerminateUploadSequence_Request > (true, ConfirmedServiceRequest_terminateUploadSequence), -2147483648, 2147483647);
                    break;
                }
                case 32:
                {
                ...
                case 73:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<ISO_9506_MMS_1A::FileRead_Request > (true, ConfirmedServiceRequest_fileRead), -2147483648, 2147483647);
                    break;
                }
                case 74:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<ISO_9506_MMS_1A::FileClose_Request > (true, ConfirmedServiceRequest_fileClose), -2147483648, 2147483647);
                    break;
                }
                case 75:
                {
    ...
    template<> void Request_Detail::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            case Request_Detail_createProgramInvocation:
            {
                ...
                ITU_T_BIND_NUM_CONSTRS(*value<CS_CreateProgramInvocation_Request > (false, Request_Detail_createProgramInvocation), 0, 2);
                break;
            }
    ...
    template<> void Request_Detail::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<CS_CreateProgramInvocation_Request > (true, Request_Detail_createProgramInvocation), 0, 2);
                break;
            }
            case 2:
            {
        ...
        if (ITU_T_EXTENTION_CHECK_PER) {
            switch (type()) {
                ...
                case ConfirmedServiceResponse_deleteEventCondition:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRS(*value<DeleteEventCondition_Response > (false, ConfirmedServiceResponse_deleteEventCondition), 0, 2147483647);
                    break;
                }
                ...
                case ConfirmedServiceResponse_deleteEventAction:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRS(*value<DeleteEventAction_Response > (false, ConfirmedServiceResponse_deleteEventAction), 0, 2147483647);
                    break;
                }
                ...
                case ConfirmedServiceResponse_reportEventActionStatus:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRS(*value<ReportEventActionStatus_Response > (false, ConfirmedServiceResponse_reportEventActionStatus), 0, 2147483647);
                    break;
                }
                ...
                case ConfirmedServiceResponse_deleteEventEnrollment:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRS(*value<DeleteEventEnrollment_Response > (false, ConfirmedServiceResponse_deleteEventEnrollment), 0, 2147483647);
                    break;
                }
                ...
                case ConfirmedServiceResponse_initializeJournal:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRS(*value<InitializeJournal_Response > (false, ConfirmedServiceResponse_initializeJournal), 0, 2147483647);
                    break;
                }
    ...
    template<> void ConfirmedServiceResponse::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        if (ITU_T_EXTENTION_CHECK_PER) {
            ...
            switch (__indx__) {
                ...
                case 47:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<DeleteEventCondition_Response > (true, ConfirmedServiceResponse_deleteEventCondition), 0, 2147483647);
                    break;
                }
                case 48:
                {
                ...
                case 53:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<DeleteEventAction_Response > (true, ConfirmedServiceResponse_deleteEventAction), 0, 2147483647);
                    break;
                }
                case 54:
                {
                ...
                case 55:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<ReportEventActionStatus_Response > (true, ConfirmedServiceResponse_reportEventActionStatus), 0, 2147483647);
                    break;
                }
                case 56:
                {
                ...
                case 57:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<DeleteEventEnrollment_Response > (true, ConfirmedServiceResponse_deleteEventEnrollment), 0, 2147483647);
                    break;
                }
                case 58:
                {
                ...
                case 66:
                {
                    ITU_T_BIND_NUM_CONSTRS(*value<InitializeJournal_Response > (true, ConfirmedServiceResponse_initializeJournal), 0, 2147483647);
                    break;
                }
                case 67:
                {
    ...
    template<> void ServiceError::ErrorClass_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            case ErrorClass_type_vmd_state:
            {
                ...
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_vmd_state), 0, 4);
                break;
            }
            case ErrorClass_type_application_reference:
            {
                ITU_T_SET_CONSTAINED_INDX(1, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_application_reference), 0, 4);
                break;
            }
            case ErrorClass_type_definition:
            {
                ITU_T_SET_CONSTAINED_INDX(2, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_definition), 0, 6);
                break;
            }
            case ErrorClass_type_resource:
            {
                ITU_T_SET_CONSTAINED_INDX(3, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_resource), 0, 5);
                break;
            }
            case ErrorClass_type_service:
            {
                ITU_T_SET_CONSTAINED_INDX(4, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_service), 0, 5);
                break;
            }
            case ErrorClass_type_service_preempt:
            {
                ITU_T_SET_CONSTAINED_INDX(5, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_service_preempt), 0, 3);
                break;
            }
            case ErrorClass_type_time_resolution:
            {
                ITU_T_SET_CONSTAINED_INDX(6, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_time_resolution), 0, 1);
                break;
            }
            case ErrorClass_type_access:
            {
                ITU_T_SET_CONSTAINED_INDX(7, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_access), 0, 4);
                break;
            }
            case ErrorClass_type_initiate:
            {
                ITU_T_SET_CONSTAINED_INDX(8, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_initiate), 0, 7);
                break;
            }
            case ErrorClass_type_conclude:
            {
                ITU_T_SET_CONSTAINED_INDX(9, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_conclude), 0, 1);
                break;
            }
            case ErrorClass_type_cancel:
            {
                ITU_T_SET_CONSTAINED_INDX(10, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_cancel), 0, 2);
                break;
            }
            case ErrorClass_type_file:
            {
                ITU_T_SET_CONSTAINED_INDX(11, 12);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ErrorClass_type_file), 0, 9);
                break;
            }
            case ErrorClass_type_others:
            {
                ITU_T_SET_CONSTAINED_INDX(12, 12);
                ITU_T_BIND_PER(*value<int > (false, ErrorClass_type_others));
                break;
            }
            default:
            {
    ...
    template<> void ServiceError::ErrorClass_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_vmd_state), 0, 4);
                break;
            }
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_application_reference), 0, 4);
                break;
            }
            case 2:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_definition), 0, 6);
                break;
            }
            case 3:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_resource), 0, 5);
                break;
            }
            case 4:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_service), 0, 5);
                break;
            }
            case 5:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_service_preempt), 0, 3);
                break;
            }
            case 6:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_time_resolution), 0, 1);
                break;
            }
            case 7:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_access), 0, 4);
                break;
            }
            case 8:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_initiate), 0, 7);
                break;
            }
            case 9:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_conclude), 0, 1);
                break;
            }
            case 10:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_cancel), 0, 2);
                break;
            }
            case 11:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ErrorClass_type_file), 0, 9);
                break;
            }
            case 12:
            {
                ITU_T_BIND_PER(*value<int > (true, ErrorClass_type_others));
                break;
            }
            default:
            {
    ...
    template<> void ServiceError::ServiceSpecificInfo_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            case ServiceSpecificInfo_type_obtainFile:
            {
                ...
                ITU_T_BIND_NUM_CONSTRS(*value<ISO_9506_MMS_1A::ObtainFile_Error > (false, ServiceSpecificInfo_type_obtainFile), 0, 1);
                break;
            }
            case ServiceSpecificInfo_type_start:
            {
                ITU_T_SET_CONSTAINED_INDX(1, 11);
                ITU_T_BIND_NUM_CONSTRS(*value<Start_Error > (false, ServiceSpecificInfo_type_start), 0, 8);
                break;
            }
            case ServiceSpecificInfo_type_stop:
            {
                ITU_T_SET_CONSTAINED_INDX(2, 11);
                ITU_T_BIND_NUM_CONSTRS(*value<Stop_Error > (false, ServiceSpecificInfo_type_stop), 0, 8);
                break;
            }
            case ServiceSpecificInfo_type_resume:
            {
                ITU_T_SET_CONSTAINED_INDX(3, 11);
                ITU_T_BIND_NUM_CONSTRS(*value<Resume_Error > (false, ServiceSpecificInfo_type_resume), 0, 8);
                break;
            }
            case ServiceSpecificInfo_type_reset:
            {
                ITU_T_SET_CONSTAINED_INDX(4, 11);
                ITU_T_BIND_NUM_CONSTRS(*value<Reset_Error > (false, ServiceSpecificInfo_type_reset), 0, 8);
                break;
            }
            case ServiceSpecificInfo_type_deleteVariableAccess:
            {
                ITU_T_SET_CONSTAINED_INDX(5, 11);
                ITU_T_BIND_NUM_CONSTRS(*value<DeleteVariableAccess_Error > (false, ServiceSpecificInfo_type_deleteVariableAccess), 0, 2147483647);
                break;
            }
            case ServiceSpecificInfo_type_deleteNamedVariableList:
            {
                ITU_T_SET_CONSTAINED_INDX(6, 11);
                ITU_T_BIND_NUM_CONSTRS(*value<DeleteNamedVariableList_Error > (false, ServiceSpecificInfo_type_deleteNamedVariableList), 0, 2147483647);
                break;
            }
            case ServiceSpecificInfo_type_deleteNamedType:
            {
                ITU_T_SET_CONSTAINED_INDX(7, 11);
                ITU_T_BIND_NUM_CONSTRS(*value<DeleteNamedType_Error > (false, ServiceSpecificInfo_type_deleteNamedType), 0, 2147483647);
                break;
            }
            ...
            case ServiceSpecificInfo_type_fileRename:
            {
                ...
                ITU_T_BIND_NUM_CONSTRS(*value<ISO_9506_MMS_1A::FileRename_Error > (false, ServiceSpecificInfo_type_fileRename), 0, 1);
                break;
            }
            ...
            case ServiceSpecificInfo_type_changeAccessControl:
            {
                ...
                ITU_T_BIND_NUM_CONSTRS(*value<ChangeAccessControl_Error > (false, ServiceSpecificInfo_type_changeAccessControl), 0, 2147483647);
                break;
            }
            default:
            {
    ...
    template<> void ServiceError::ServiceSpecificInfo_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<ISO_9506_MMS_1A::ObtainFile_Error > (true, ServiceSpecificInfo_type_obtainFile), 0, 1);
                break;
            }
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Start_Error > (true, ServiceSpecificInfo_type_start), 0, 8);
                break;
            }
            case 2:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Stop_Error > (true, ServiceSpecificInfo_type_stop), 0, 8);
                break;
            }
            case 3:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Resume_Error > (true, ServiceSpecificInfo_type_resume), 0, 8);
                break;
            }
            case 4:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Reset_Error > (true, ServiceSpecificInfo_type_reset), 0, 8);
                break;
            }
            case 5:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<DeleteVariableAccess_Error > (true, ServiceSpecificInfo_type_deleteVariableAccess), 0, 2147483647);
                break;
            }
            case 6:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<DeleteNamedVariableList_Error > (true, ServiceSpecificInfo_type_deleteNamedVariableList), 0, 2147483647);
                break;
            }
            case 7:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<DeleteNamedType_Error > (true, ServiceSpecificInfo_type_deleteNamedType), 0, 2147483647);
                break;
            }
            case 8:
            {
            ...
            case 9:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<ISO_9506_MMS_1A::FileRename_Error > (true, ServiceSpecificInfo_type_fileRename), 0, 1);
                break;
            }
            case 10:
            {
            ...
            case 11:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<ChangeAccessControl_Error > (true, ServiceSpecificInfo_type_changeAccessControl), 0, 2147483647);
                break;
            }
            default:
            {
    ...
    template<> void ObjectClass::serialize(boost::asn1::x691::output_coder& arch) {
        ...
        if (ITU_T_EXTENTION_CHECK_PER) {
            ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ObjectClass_basicObjectClass), 0, 13)
        }
        else {
            switch (type()) {
                ...
                {
                    ITU_T_SET_NSN_SMALL_INDX(0);
                    ITU_T_BIND_NUM_CONSTRS(*value<int > (false, ObjectClass_csObjectClass), 0, 1);
                    break;
                }
                default:
                {
    ...
    template<> void ObjectClass::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        if (ITU_T_EXTENTION_CHECK_PER) {
            ITU_T_BIND_NUM_CONSTRS(*value<int > (true, ObjectClass_basicObjectClass), 0, 13)
        }
        else {
    ...
    template<> void RejectPDU::RejectReason_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            case RejectReason_type_confirmed_requestPDU:
            {
                ...
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_confirmed_requestPDU), 0, 9);
                break;
            }
            case RejectReason_type_confirmed_responsePDU:
            {
                ITU_T_SET_CONSTAINED_INDX(1, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_confirmed_responsePDU), 0, 6);
                break;
            }
            case RejectReason_type_confirmed_errorPDU:
            {
                ITU_T_SET_CONSTAINED_INDX(2, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_confirmed_errorPDU), 0, 4);
                break;
            }
            case RejectReason_type_unconfirmedPDU:
            {
                ITU_T_SET_CONSTAINED_INDX(3, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_unconfirmedPDU), 0, 4);
                break;
            }
            case RejectReason_type_pdu_error:
            {
                ITU_T_SET_CONSTAINED_INDX(4, 10);
                ITU_T_BIND_PER(*value<int > (false, RejectReason_type_pdu_error));
                break;
            }
            case RejectReason_type_cancel_requestPDU:
            {
                ITU_T_SET_CONSTAINED_INDX(5, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_cancel_requestPDU), 0, 1);
                break;
            }
            case RejectReason_type_cancel_responsePDU:
            {
                ITU_T_SET_CONSTAINED_INDX(6, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_cancel_responsePDU), 0, 1);
                break;
            }
            case RejectReason_type_cancel_errorPDU:
            {
                ITU_T_SET_CONSTAINED_INDX(7, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_cancel_errorPDU), 0, 3);
                break;
            }
            case RejectReason_type_conclude_requestPDU:
            {
                ITU_T_SET_CONSTAINED_INDX(8, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_conclude_requestPDU), 0, 1);
                break;
            }
            case RejectReason_type_conclude_responsePDU:
            {
                ITU_T_SET_CONSTAINED_INDX(9, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_conclude_responsePDU), 0, 1);
                break;
            }
            case RejectReason_type_conclude_errorPDU:
            {
                ITU_T_SET_CONSTAINED_INDX(10, 10);
                ITU_T_BIND_NUM_CONSTRS(*value<int > (false, RejectReason_type_conclude_errorPDU), 0, 2);
                break;
            }
            default:
            {
    ...
    template<> void RejectPDU::RejectReason_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_confirmed_requestPDU), 0, 9);
                break;
            }
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_confirmed_responsePDU), 0, 6);
                break;
            }
            case 2:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_confirmed_errorPDU), 0, 4);
                break;
            }
            case 3:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_unconfirmedPDU), 0, 4);
                break;
            }
            case 4:
            {
                ITU_T_BIND_PER(*value<int > (true, RejectReason_type_pdu_error));
                break;
            }
            case 5:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_cancel_requestPDU), 0, 1);
                break;
            }
            case 6:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_cancel_responsePDU), 0, 1);
                break;
            }
            case 7:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_cancel_errorPDU), 0, 3);
                break;
            }
            case 8:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_conclude_requestPDU), 0, 1);
                break;
            }
            case 9:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_conclude_responsePDU), 0, 1);
                break;
            }
            case 10:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<int > (true, RejectReason_type_conclude_errorPDU), 0, 2);
                break;
            }
            default:
            {
    ...
    template<> void StatusResponse::serialize(boost::asn1::x691::output_coder& arch) {
        ...
        ITU_T_BIND_SIZE_RNGCONSTRS(localDetail_, 0, 128);
    }
    ...
    template<> void StatusResponse::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        ITU_T_BIND_NUM_CONSTRS(*vmdLogicalStatus_, 0, 3);
        ITU_T_BIND_NUM_CONSTRS(*vmdPhysicalStatus_, 0, 3);
        ITU_T_OPTIONAL_CHECK_PER(0) ITU_T_BIND_SIZE_RNGCONSTRS(localDetail_, 0, 128);
    }
    ...
    template<> void StartCount::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 2);
                ITU_T_BIND_PER(*value<int > (false, StartCount_cycleCount));
                break;
            }
            case StartCount_stepCount:
            {
                ITU_T_SET_CONSTAINED_INDX(2, 2);
                ITU_T_BIND_PER(*value<int > (false, StartCount_stepCount));
                break;
            }
            default:
            {
    ...
    template<> void StartCount::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_PER(*value<int > (true, StartCount_cycleCount));
                break;
            }
            case 2:
            {
                ITU_T_BIND_PER(*value<int > (true, StartCount_stepCount));
                break;
            }
            default:
            {
    ...
    template<> void CS_GetProgramInvocationAttributes_Response::Control_type::Controlling_type::RunningMode_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 2);
                ITU_T_BIND_PER(*value<int > (false, RunningMode_type_cycleLimited));
                break;
            }
            case RunningMode_type_stepLimited:
            {
                ITU_T_SET_CONSTAINED_INDX(2, 2);
                ITU_T_BIND_PER(*value<int > (false, RunningMode_type_stepLimited));
                break;
            }
            default:
            {
    ...
    template<> void CS_GetProgramInvocationAttributes_Response::Control_type::Controlling_type::RunningMode_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_PER(*value<int > (true, RunningMode_type_cycleLimited));
                break;
            }
            case 2:
            {
                ITU_T_BIND_PER(*value<int > (true, RunningMode_type_stepLimited));
                break;
            }
            default:
            {
    ...
    template<> void UnitControlUpload_Request::ContinueAfter_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 2);
                ITU_T_BIND_PER(*value<int > (false, ContinueAfter_type_ulsmID));
                break;
            }
    ...
    template<> void UnitControlUpload_Request::ContinueAfter_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_PER(*value<int > (true, ContinueAfter_type_ulsmID));
                break;
            }
            case 2:
            {
    ...
    template<> void UnitControlUpload_Response::NextElement_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 2);
                ITU_T_BIND_PER(*value<int > (false, NextElement_type_ulsmID));
                break;
            }
    ...
    template<> void UnitControlUpload_Response::NextElement_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_PER(*value<int > (true, NextElement_type_ulsmID));
                break;
            }
            case 2:
            {
    ...
    template<> void AlternateAccessSelection::SelectAlternateAccess_type::AccessSelection_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 3);
                ITU_T_BIND_NUM_CONSTRS(*value<Unsigned32 > (false, AccessSelection_type_index), 0, 2147483647);
                break;
            }
    ...
    template<> void AlternateAccessSelection::SelectAlternateAccess_type::AccessSelection_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Unsigned32 > (true, AccessSelection_type_index), 0, 2147483647);
                break;
            }
            case 2:
            {
    ...
    template<> void AlternateAccessSelection::SelectAccess_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 3);
                ITU_T_BIND_NUM_CONSTRS(*value<Unsigned32 > (false, SelectAccess_type_index), 0, 2147483647);
                break;
            }
    ...
    template<> void AlternateAccessSelection::SelectAccess_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Unsigned32 > (true, SelectAccess_type_index), 0, 2147483647);
                break;
            }
            case 2:
            {
    ...
    template<> void AccessResult::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 1);
                ITU_T_BIND_NUM_CONSTRS(*value<DataAccessError > (false, AccessResult_failure), 0, 11);
                break;
            }
            default:
            {
    ...
    template<> void AccessResult::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<DataAccessError > (true, AccessResult_failure), 0, 11);
                break;
            }
            default:
            {
    ...
    template<> void Data::serialize(boost::asn1::x691::output_coder& arch) {
        ...
        if (ITU_T_EXTENTION_CHECK_PER) {
            switch (type()) {
                ...
                {
                    ITU_T_SET_CONSTAINED_INDX(4, 13);
                    ITU_T_BIND_PER(*value<int > (false, Data_integer));
                    break;
                }
                case Data_unsignedV:
                {
                    ITU_T_SET_CONSTAINED_INDX(5, 13);
                    ITU_T_BIND_PER(*value<int > (false, Data_unsignedV));
                    break;
                }
                ...
                {
                    ITU_T_SET_CONSTAINED_INDX(10, 13);
                    ITU_T_BIND_SIZE_RNGCONSTRS(*value<TimeOfDay > (false, Data_binary_time), 4, 6);
                    break;
                }
                case Data_bcd:
                {
                    ITU_T_SET_CONSTAINED_INDX(11, 13);
                    ITU_T_BIND_PER(*value<int > (false, Data_bcd));
                    break;
                }
    ...
    template<> void Data::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        if (ITU_T_EXTENTION_CHECK_PER) {
            ...
            switch (__indx__) {
                ...
                case 4:
                {
                    ITU_T_BIND_PER(*value<int > (true, Data_integer));
                    break;
                }
                case 5:
                {
                    ITU_T_BIND_PER(*value<int > (true, Data_unsignedV));
                    break;
                }
                case 6:
                {
                ...
                case 10:
                {
                    ITU_T_BIND_SIZE_RNGCONSTRS(*value<TimeOfDay > (true, Data_binary_time), 4, 6);
                    break;
                }
                case 11:
                {
                    ITU_T_BIND_PER(*value<int > (true, Data_bcd));
                    break;
                }
                case 12:
                {
    ...
    template<> void Write_Response_sequence_of::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(0, 1);
                ITU_T_BIND_NUM_CONSTRS(*value<DataAccessError > (false, Write_Response_sequence_of_failure), 0, 11);
                break;
            }
    ...
    template<> void Write_Response_sequence_of::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<DataAccessError > (true, Write_Response_sequence_of_failure), 0, 11);
                break;
            }
            case 1:
            {
    ...
    template<> void EventNotification::ActionResult_type::SuccessOrFailure_type::Success_type::serialize(boost::asn1::x691::output_coder& arch) {
        ...
        ITU_T_OPTIONAL_DECL_PER = ITU_T_OPTIONAL_PER(cs - Response - Detail_);
    ...
    template<> void CS_EventNotification_impl::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(2, 2);
                ITU_T_BIND_PER(*value<int > (false, CS_EventNotification_impl_index));
                break;
            }
            default:
            {
    ...
    template<> void CS_EventNotification_impl::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 2:
            {
                ITU_T_BIND_PER(*value<int > (true, CS_EventNotification_impl_index));
                break;
            }
            default:
            {
    ...
    template<> void EN_Additional_Detail_impl::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(2, 2);
                ITU_T_BIND_PER(*value<int > (false, EN_Additional_Detail_impl_index));
                break;
            }
            default:
            {
    ...
    template<> void EN_Additional_Detail_impl::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 2:
            {
                ITU_T_BIND_PER(*value<int > (true, EN_Additional_Detail_impl_index));
                break;
            }
            default:
            {
    ...
    template<> void CS_DefineEventCondition_Request_impl::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(2, 2);
                ITU_T_BIND_PER(*value<int > (false, CS_DefineEventCondition_Request_impl_index));
                break;
            }
            default:
            {
    ...
    template<> void CS_DefineEventCondition_Request_impl::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 2:
            {
                ITU_T_BIND_PER(*value<int > (true, CS_DefineEventCondition_Request_impl_index));
                break;
            }
            default:
            {
    ...
    template<> void CS_GetEventConditionAttributes_Response::GroupPriorityOverride_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(0, 1);
                ITU_T_BIND_NUM_CONSTRS(*value<MMS_Object_Module_1::Priority > (false, GroupPriorityOverride_type_priority), 0, 127);
                break;
            }
    ...
    template<> void CS_GetEventConditionAttributes_Response::GroupPriorityOverride_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<MMS_Object_Module_1::Priority > (true, GroupPriorityOverride_type_priority), 0, 127);
                break;
            }
            case 1:
            {
    ...
    template<> void CS_GetEventConditionAttributes_Response::DisplayEnhancement_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 2);
                ITU_T_BIND_PER(*value<int > (false, DisplayEnhancement_type_index));
                break;
            }
    ...
    template<> void CS_GetEventConditionAttributes_Response::DisplayEnhancement_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_PER(*value<int > (true, DisplayEnhancement_type_index));
                break;
            }
            case 2:
            {
    ...
    template<> void CS_AlterEventConditionMonitoring_Request::ChangeDisplay_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(1, 2);
                ITU_T_BIND_PER(*value<int > (false, ChangeDisplay_type_index));
                break;
            }
    ...
    template<> void CS_AlterEventConditionMonitoring_Request::ChangeDisplay_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 1:
            {
                ITU_T_BIND_PER(*value<int > (true, ChangeDisplay_type_index));
                break;
            }
            case 2:
            {
    ...
    template<> void DefineEventAction_Request::serialize(boost::asn1::x691::output_coder& arch) {
        ...
        ITU_T_OPTIONAL_DECL_PER = ITU_T_OPTIONAL_PER(listOfModifier_) + ITU_T_OPTIONAL_PER(cs - extension_);
    ...
    template<> void GetEventActionAttributes_Response::serialize(boost::asn1::x691::output_coder& arch) {
        ...
        ITU_T_OPTIONAL_DECL_PER = ITU_T_OPTIONAL_PER(mmsDeletable_) + ITU_T_OPTIONAL_PER(cs - extension_) + ITU_T_OPTIONAL_PER(accessControlList_);
    ...
    template<> void CS_DefineEventEnrollment_Request_impl::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(2, 2);
                ITU_T_BIND_PER(*value<int > (false, CS_DefineEventEnrollment_Request_impl_index));
                break;
            }
            default:
            {
    ...
    template<> void CS_DefineEventEnrollment_Request_impl::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            ...
            case 2:
            {
                ITU_T_BIND_PER(*value<int > (true, CS_DefineEventEnrollment_Request_impl_index));
                break;
            }
            default:
            {
    ...
    template<> void AlterEventConditionListMonitoring_Request::PriorityChange_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(0, 1);
                ITU_T_BIND_PER(*value<int > (false, PriorityChange_type_priorityValue));
                break;
            }
    ...
    template<> void AlterEventConditionListMonitoring_Request::PriorityChange_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_PER(*value<int > (true, PriorityChange_type_priorityValue));
                break;
            }
            case 1:
            {
    ...
    template<> void ReadJournal_Request::RangeStartSpecification_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(0, 1);
                ITU_T_BIND_SIZE_RNGCONSTRS(*value<TimeOfDay > (false, RangeStartSpecification_type_startingTime), 4, 6);
                break;
            }
    ...
    template<> void ReadJournal_Request::RangeStartSpecification_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_SIZE_RNGCONSTRS(*value<TimeOfDay > (true, RangeStartSpecification_type_startingTime), 4, 6);
                break;
            }
            case 1:
            {
    ...
    template<> void ReadJournal_Request::RangeStopSpecification_type::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(0, 1);
                ITU_T_BIND_SIZE_RNGCONSTRS(*value<TimeOfDay > (false, RangeStopSpecification_type_endingTime), 4, 6);
                break;
            }
            case RangeStopSpecification_type_numberOfEntries:
            {
                ITU_T_SET_CONSTAINED_INDX(1, 1);
                ITU_T_BIND_NUM_CONSTRS(*value<Integer32 > (false, RangeStopSpecification_type_numberOfEntries), -2147483648, 2147483647);
                break;
            }
            default:
            {
    ...
    template<> void ReadJournal_Request::RangeStopSpecification_type::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_SIZE_RNGCONSTRS(*value<TimeOfDay > (true, RangeStopSpecification_type_endingTime), 4, 6);
                break;
            }
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRS(*value<Integer32 > (true, RangeStopSpecification_type_numberOfEntries), -2147483648, 2147483647);
                break;
            }
            default:
            {
    ...
    template<> void ReadJournal_Request::EntryToStartAfter_type::serialize(boost::asn1::x691::output_coder& arch) {
        ITU_T_BIND_SIZE_RNGCONSTRS(*timeSpecification_, 4, 6);
    ...
    template<> void InitializeJournal_Request::LimitSpecification_type::serialize(boost::asn1::x691::output_coder& arch) {
        ...
        ITU_T_BIND_SIZE_RNGCONSTRS(*limitingTime_, 4, 6);
    ...
    template<> void EntryContent::serialize(boost::asn1::x691::output_coder& arch) {
        ITU_T_BIND_SIZE_RNGCONSTRS(*occurrenceTime_, 4, 6);
