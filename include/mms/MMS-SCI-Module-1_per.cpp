...
namespace MMS_SCI_Module_1 {
        ...
        ITU_T_PER_ENUMCODER(Semaphore_instance__Definition_type__Details_type__enumerated_type__helper, ITU_T_ARRAY(0, 1));


        //  helper name:   Operator_Station_instance__Definition_type__Details_type__enumerated_type           type:  enumerated helper    
        ITU_T_PER_ENUMCODER(Operator_Station_instance__Definition_type__Details_type__enumerated_type__helper, ITU_T_ARRAY(0, 1, 2));


        //  helper name:   Journal_Entry_instance__enumerated_type           type:  enumerated helper    
        ITU_T_PER_ENUMCODER(Journal_Entry_instance__enumerated_type__helper, ITU_T_ARRAY(0, 1, 2));
        ...
        template<> void VMD_File::serialize(boost::asn1::x691::output_coder& arch){
            ...
            ITU_T_BIND_NUM_CONSTRS( *(*logicalStatus_), 0, 3);
            ITU_T_BIND_PER(*capabilities_);
            ITU_T_BIND_NUM_CONSTRS( *(*physicalStatus_), 0, 3);
        ...
        template<> void VMD_File::Selected_Program_Invocation_type::serialize(boost::asn1::x691::output_coder& arch){
            switch(type()){
                case Selected_Program_Invocation_type_selectedProgram:  { ITU_T_SET_CONSTAINED_INDX(0 , 1); ITU_T_BIND_PER(*value<Program_Invocation_instance > (false , Selected_Program_Invocation_type_selectedProgram)); break; }
                case Selected_Program_Invocation_type_noneSelected:  { ITU_T_SET_CONSTAINED_INDX(1 , 1); ITU_T_BIND_PER(*value<null_type > (false , Selected_Program_Invocation_type_noneSelected)); break; }
                default:{}
            }
        }
        ...
        template<> void VMD_File::Selected_Program_Invocation_type::serialize(boost::asn1::x691::input_coder& arch){
            ...
            switch(__indx__){
                case 0:  {ITU_T_BIND_PER(*value<Program_Invocation_instance > (true , Selected_Program_Invocation_type_selectedProgram)); break; }
                case 1:  {ITU_T_BIND_PER(*value<null_type > (true , Selected_Program_Invocation_type_noneSelected)); break; }
                default:{}
            }
        }
        ...
        template<> void Access_Control_List_instance::Definition_type::serialize(boost::asn1::x691::output_coder& arch){
            switch(type()){
                case Definition_type_reference:  { ITU_T_SET_CONSTAINED_INDX(0 , 1); ITU_T_BIND_PER(*value<oid_type > (false , Definition_type_reference)); break; }
                case Definition_type_details:  { ITU_T_SET_CONSTAINED_INDX(1 , 1); ITU_T_BIND_PER(*value<Details_type > (false , Definition_type_details)); break; }
                default:{}
            }
        }
        ...
        template<> void Access_Control_List_instance::Definition_type::serialize(boost::asn1::x691::input_coder& arch){
            ...
            switch(__indx__){
                case 0:  {ITU_T_BIND_PER(*value<oid_type > (true , Definition_type_reference)); break; }
                case 1:  {ITU_T_BIND_PER(*value<Details_type > (true , Definition_type_details)); break; }
                default:{}
            }
        }
        ...
        template<> void Event_Condition_instance::Definition_type::Details_type::serialize(boost::asn1::x691::output_coder& arch){
            ...
            ITU_T_BIND_PER(*accessControl_);
            ITU_T_BIND_NUM_CONSTRS( *ecClass_, 0, 1);
            ITU_T_BIND_NUM_CONSTRS( *ecState_, 0, 2);
        ...
        template<> void Event_Condition_instance::Definition_type::Details_type::MonitoredVariable_type::serialize(boost::asn1::x691::output_coder& arch){
            switch(type()){
                case MonitoredVariable_type_named:  { ITU_T_SET_CONSTAINED_INDX(0 , 2); ITU_T_BIND_PER(*value<Named_Variable_instance > (false , MonitoredVariable_type_named)); break; }
                case MonitoredVariable_type_unnamed:  { ITU_T_SET_CONSTAINED_INDX(1 , 2); ITU_T_BIND_PER(*value<Unnamed_Variable_instance > (false , MonitoredVariable_type_unnamed)); break; }
                case MonitoredVariable_type_unspecified:  { ITU_T_SET_CONSTAINED_INDX(2 , 2); ITU_T_BIND_PER(*value<null_type > (false , MonitoredVariable_type_unspecified)); break; }
                default:{}
            }
        }
        ...
        template<> void Event_Condition_instance::Definition_type::Details_type::MonitoredVariable_type::serialize(boost::asn1::x691::input_coder& arch){
            ...
            switch(__indx__){
                case 0:  {ITU_T_BIND_PER(*value<Named_Variable_instance > (true , MonitoredVariable_type_named)); break; }
                case 1:  {ITU_T_BIND_PER(*value<Unnamed_Variable_instance > (true , MonitoredVariable_type_unnamed)); break; }
                case 2:  {ITU_T_BIND_PER(*value<null_type > (true , MonitoredVariable_type_unspecified)); break; }
                default:{}
            }
        }
        ...
        template<> void Event_Condition_instance::Definition_type::Details_type::DisplayEnhancement_type::serialize(boost::asn1::x691::output_coder& arch){
            switch(type()){
                case DisplayEnhancement_type_text:  { ITU_T_SET_CONSTAINED_INDX(0 , 2); ITU_T_BIND_PER(*value<ISO_9506_MMS_1::MMSString > (false , DisplayEnhancement_type_text)); break; }
                case DisplayEnhancement_type_number:  { ITU_T_SET_CONSTAINED_INDX(1 , 2); ITU_T_BIND_PER(*value<int > (false , DisplayEnhancement_type_number)); break; }
                case DisplayEnhancement_type_none:  { ITU_T_SET_CONSTAINED_INDX(2 , 2); ITU_T_BIND_PER(*value<null_type > (false , DisplayEnhancement_type_none)); break; }
                default:{}
            }
        }
        ...
        template<> void Event_Condition_instance::Definition_type::Details_type::DisplayEnhancement_type::serialize(boost::asn1::x691::input_coder& arch){
            ...
            switch(__indx__){
                case 0:  {ITU_T_BIND_PER(*value<ISO_9506_MMS_1::MMSString > (true , DisplayEnhancement_type_text)); break; }
                case 1:  {ITU_T_BIND_PER(*value<int > (true , DisplayEnhancement_type_number)); break; }
                case 2:  {ITU_T_BIND_PER(*value<null_type > (true , DisplayEnhancement_type_none)); break; }
                default:{}
            }
        }
        ...
        template<> void Event_Condition_instance::Definition_type::Details_type::Group_Priority_Override_type::serialize(boost::asn1::x691::output_coder& arch){
            switch(type()){
                case Group_Priority_Override_type_priority:  { ITU_T_SET_CONSTAINED_INDX(0 , 1); ITU_T_BIND_NUM_CONSTRS( *value<MMS_Object_Module_1::Priority > (false , Group_Priority_Override_type_priority), 0, 127); break; }
                case Group_Priority_Override_type_undefined:  { ITU_T_SET_CONSTAINED_INDX(1 , 1); ITU_T_BIND_PER(*value<null_type > (false , Group_Priority_Override_type_undefined)); break; }
                default:{}
            }
        }
        ...
        template<> void Event_Condition_instance::Definition_type::Details_type::Group_Priority_Override_type::serialize(boost::asn1::x691::input_coder& arch){
            ...
            switch(__indx__){
                case 0:  {ITU_T_BIND_NUM_CONSTRS( *value<MMS_Object_Module_1::Priority > (true , Group_Priority_Override_type_priority), 0, 127); break; }
                case 1:  {ITU_T_BIND_PER(*value<null_type > (true , Group_Priority_Override_type_undefined)); break; }
                default:{}
            }
        }
        ...
        template<> void Event_Enrollment_instance::Definition_type::Details_type::serialize(boost::asn1::x691::output_coder& arch){
            ...
            ITU_T_BIND_PER(*accessControl_);
            ITU_T_BIND_NUM_CONSTRS( *eeClass_, 0, 1);
            ITU_T_BIND_PER(*eventCondition_);
            ...
            ITU_T_BIND_NUM_CONSTRS( aaRule_, 0, 3);
        }
        ...
        template<> void Event_Enrollment_instance::Definition_type::Details_type::serialize(boost::asn1::x691::input_coder& arch){
            ...
            ITU_T_OPTIONAL_CHECK_PER(1)  ITU_T_BIND_PER(eventAction_);
            ITU_T_OPTIONAL_CHECK_PER(2)  ITU_T_BIND_NUM_CONSTRS( duration_, 0, 1);
            ITU_T_OPTIONAL_CHECK_PER(3)  ITU_T_BIND_PER(clientApplication_);
            ITU_T_OPTIONAL_CHECK_PER(4)  ITU_T_BIND_NUM_CONSTRS( aaRule_, 0, 3);
        }
        ...
        template<> void Event_Enrollment_instance::Definition_type::Details_type::RemainingDelay_type::serialize(boost::asn1::x691::output_coder& arch){
            switch(type()){
                case RemainingDelay_type_time:  { ITU_T_SET_CONSTAINED_INDX(0 , 1); ITU_T_BIND_PER(*value<int > (false , RemainingDelay_type_time)); break; }
                case RemainingDelay_type_forever:  { ITU_T_SET_CONSTAINED_INDX(1 , 1); ITU_T_BIND_PER(*value<null_type > (false , RemainingDelay_type_forever)); break; }
                default:{}
            }
        }
        ...
        template<> void Event_Enrollment_instance::Definition_type::Details_type::RemainingDelay_type::serialize(boost::asn1::x691::input_coder& arch){
            ...
            switch(__indx__){
                case 0:  {ITU_T_BIND_PER(*value<int > (true , RemainingDelay_type_time)); break; }
                case 1:  {ITU_T_BIND_PER(*value<null_type > (true , RemainingDelay_type_forever)); break; }
                default:{}
            }
        }
