...
namespace MMS_Object_Module_1 {
    ...
    template<> void Address::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            case Address_numericAddress:
            {
                ...
                ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned32 > (false, Address_numericAddress), static_cast<uint32_t> (0), static_cast<uint32_t> (std::numeric_limits<int32_t>::max()));
                break;
            }
            ...
            case Address_unconstrainedAddress:
            {
                ...
                ITU_T_BIND_PER(value<octet_string > (false, Address_unconstrainedAddress));
                break;
            }
            default:
            {
    ...
    template<> void Address::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned32 > (true, Address_numericAddress), static_cast<uint32_t> (0), static_cast<uint32_t> (std::numeric_limits<int32_t>::max()));
                break;
            }
            case 1:
            {
            ...
            case 2:
            {
                ITU_T_BIND_PER(value<octet_string > (true, Address_unconstrainedAddress));
                break;
            }
            default:
            {
        ...
        if (!ITU_T_EXTENTION) {
            switch (type()) {
                ...
                case TypeDescription_bit_stringV:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Integer32 > (false, TypeDescription_bit_stringV), static_cast<int32_t> (std::numeric_limits<int32_t>::min()), static_cast<int32_t> (std::numeric_limits<int32_t>::max()));
                    break;
                }
                case TypeDescription_integer:
                {
                    ITU_T_SET_CONSTAINED_INDX(4, 12);
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned8 > (false, TypeDescription_integer), static_cast<uint8_t> (0), static_cast<uint8_t> (std::numeric_limits<int8_t>::max()));
                    break;
                }
                case TypeDescription_unsignedV:
                {
                    ITU_T_SET_CONSTAINED_INDX(5, 12);
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned8 > (false, TypeDescription_unsignedV), static_cast<uint8_t> (0), static_cast<uint8_t> (std::numeric_limits<int8_t>::max()));
                    break;
                }
                ...
                case TypeDescription_octet_stringV:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Integer32 > (false, TypeDescription_octet_stringV), static_cast<int32_t> (std::numeric_limits<int32_t>::min()), static_cast<int32_t> (std::numeric_limits<int32_t>::max()));
                    break;
                }
                case TypeDescription_visible_stringV:
                {
                    ITU_T_SET_CONSTAINED_INDX(8, 12);
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Integer32 > (false, TypeDescription_visible_stringV), static_cast<int32_t> (std::numeric_limits<int32_t>::min()), static_cast<int32_t> (std::numeric_limits<int32_t>::max()));
                    break;
                }
                ...
                case TypeDescription_bcd:
                {
                    ...
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned8 > (false, TypeDescription_bcd), static_cast<uint8_t> (0), static_cast<uint8_t> (std::numeric_limits<int8_t>::max()));
                    break;
                }
            ...
            switch (type()) {
                case TypeDescription_mMSString:
                {
                    ...
                    ITU_T_START_OPEN;
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Integer32 > (false, TypeDescription_mMSString), static_cast<int32_t> (std::numeric_limits<int32_t>::min()), static_cast<int32_t> (std::numeric_limits<int32_t>::max()));
                    ITU_T_END_OPEN;
                    break;
                }
                default:
    ...
    template<> void TypeDescription::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        if (!ITU_T_EXTENTION) {
            ...
            switch (__indx__) {
                ...
                case 3:
                {
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Integer32 > (true, TypeDescription_bit_stringV), static_cast<int32_t> (std::numeric_limits<int32_t>::min()), static_cast<int32_t> (std::numeric_limits<int32_t>::max()));
                    break;
                }
                case 4:
                {
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned8 > (true, TypeDescription_integer), static_cast<uint8_t> (0), static_cast<uint8_t> (std::numeric_limits<int8_t>::max()));
                    break;
                }
                case 5:
                {
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned8 > (true, TypeDescription_unsignedV), static_cast<uint8_t> (0), static_cast<uint8_t> (std::numeric_limits<int8_t>::max()));
                    break;
                }
                case 6:
                {
                ...
                case 7:
                {
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Integer32 > (true, TypeDescription_octet_stringV), static_cast<int32_t> (std::numeric_limits<int32_t>::min()), static_cast<int32_t> (std::numeric_limits<int32_t>::max()));
                    break;
                }
                case 8:
                {
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Integer32 > (true, TypeDescription_visible_stringV), static_cast<int32_t> (std::numeric_limits<int32_t>::min()), static_cast<int32_t> (std::numeric_limits<int32_t>::max()));
                    break;
                }
                case 9:
                {
                ...
                case 11:
                {
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned8 > (true, TypeDescription_bcd), static_cast<uint8_t> (0), static_cast<uint8_t> (std::numeric_limits<int8_t>::max()));
                    break;
                }
                case 12:
                {
            ...
            switch (__indx__) {
                ...
                {
                    ITU_T_START_OPEN;
                    ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Integer32 > (true, TypeDescription_mMSString), static_cast<int32_t> (std::numeric_limits<int32_t>::min()), static_cast<int32_t> (std::numeric_limits<int32_t>::max()));
                    ITU_T_END_OPEN;
                    break;
                }
                default:
    ...
    template<> void TypeDescription::Floating_point_type::serialize(boost::asn1::x691::output_coder& arch) {
        ITU_T_BIND_NUM_CONSTRAINT(format_width_, static_cast<uint8_t> (0), static_cast<uint8_t> (std::numeric_limits<int8_t>::max()));
        ITU_T_BIND_NUM_CONSTRAINT(exponent_width_, static_cast<uint8_t> (0), static_cast<uint8_t> (std::numeric_limits<int8_t>::max()));
    }
    ...
    template<> void EventTime::serialize(boost::asn1::x691::output_coder& arch) {
        switch (type()) {
            ...
            {
                ITU_T_SET_CONSTAINED_INDX(0, 2);
                ITU_T_BIND_SIZE_CONSTRAINT(value<ISO_9506_MMS_1::TimeOfDay > (false, EventTime_timeOfDay), 4, 6);
                break;
            }
            case EventTime_timeSequenceIdentifier:
            {
                ITU_T_SET_CONSTAINED_INDX(1, 2);
                ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned32 > (false, EventTime_timeSequenceIdentifier), static_cast<uint32_t> (0), static_cast<uint32_t> (std::numeric_limits<int32_t>::max()));
                break;
            }
    ...
    template<> void EventTime::serialize(boost::asn1::x691::input_coder& arch) {
        ...
        switch (__indx__) {
            case 0:
            {
                ITU_T_BIND_SIZE_CONSTRAINT(value<ISO_9506_MMS_1::TimeOfDay > (true, EventTime_timeOfDay), 4, 6);
                break;
            }
            case 1:
            {
                ITU_T_BIND_NUM_CONSTRAINT(value<ISO_9506_MMS_1::Unsigned32 > (true, EventTime_timeSequenceIdentifier), static_cast<uint32_t> (0), static_cast<uint32_t> (std::numeric_limits<int32_t>::max()));
                break;
            }
            case 2:
            {
