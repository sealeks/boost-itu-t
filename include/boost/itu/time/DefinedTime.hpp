...
namespace boost {
    namespace asn1 {
        ...
        struct DATE_ENCODING {
            ...
            DATE_ENCODING(const YEAR_ENCODING& arg__year,
                    const uint8_t& arg__month,
                    const uint8_t& arg__day);

            DATE_ENCODING(ITU_T_SHARED(YEAR_ENCODING) arg__year,
                    ITU_T_SHARED(uint8_t) arg__month,
        ...
        struct ANY_DATE_ENCODING {
            ...
            ANY_DATE_ENCODING(const ANY_YEAR_ENCODING& arg__year,
                    const uint8_t& arg__month,
                    const uint8_t& arg__day);

            ANY_DATE_ENCODING(ITU_T_SHARED(ANY_YEAR_ENCODING) arg__year,
                    ITU_T_SHARED(uint8_t) arg__month,
                    ITU_T_SHARED(uint8_t) arg__day);
        ...
        struct HOURS_AND_DIFF_ENCODING {
            ...
            HOURS_AND_DIFF_ENCODING(ITU_T_SHARED(uint8_t) arg__local_hours,
        ...
        struct MINUTES_ENCODING {
            ...
            MINUTES_ENCODING(ITU_T_SHARED(uint8_t) arg__hours,
                    ITU_T_SHARED(uint8_t) arg__minutes);
        ...
        struct MINUTES_UTC_ENCODING {
            ...
            MINUTES_UTC_ENCODING(ITU_T_SHARED(uint8_t) arg__hours,
                    ITU_T_SHARED(uint8_t) arg__minutes);
        ...
        struct MINUTES_AND_DIFF_ENCODING {
            ...
            MINUTES_AND_DIFF_ENCODING(const Local_time_type& arg__local_time,
                    const TIME_DIFFERENCE& arg__time_difference);

            MINUTES_AND_DIFF_ENCODING(ITU_T_SHARED(Local_time_type) arg__local_time,
                    ITU_T_SHARED(TIME_DIFFERENCE) arg__time_difference);
        ...
        ITU_T_ARCHIVE_X690_DECL(MINUTES_AND_DIFF_ENCODING::Local_time_type);
        ...
        //ITU_T_ARCHIVE_X690_DECL(START_END_DATE_TIME_INTERVAL_ENCODING::Start_type);
        //ITU_T_ARCHIVE_X690_DECL(START_END_DATE_TIME_INTERVAL_ENCODING::End_type);
        ...
        //ITU_T_ARCHIVE_X690_DECL(START_DATE_TIME_DURATION_INTERVAL_ENCODING::Start_type);
        ...
        //ITU_T_ARCHIVE_X690_DECL(DURATION_END_DATE_TIME_INTERVAL_ENCODING::End_type);
        ...
        //ITU_T_ARCHIVE_X690_DECL(REC_START_END_DATE_TIME_INTERVAL_ENCODING::Start_type);
        //ITU_T_ARCHIVE_X690_DECL(REC_START_END_DATE_TIME_INTERVAL_ENCODING::End_type);
        ...
        //ITU_T_ARCHIVE_X690_DECL(REC_START_DATE_TIME_DURATION_INTERVAL_ENCODING::Start_type);
        ...
        //ITU_T_ARCHIVE_X690_DECL(REC_DURATION_END_DATE_TIME_INTERVAL_ENCODING::End_type);
        ...
        ITU_T_ARCHIVE_X691_DECL(MINUTES_AND_DIFF_ENCODING::Local_time_type);
        ...
        //ITU_T_ARCHIVE_X691_DECL(START_END_DATE_TIME_INTERVAL_ENCODING::Start_type);
        //ITU_T_ARCHIVE_X691_DECL(START_END_DATE_TIME_INTERVAL_ENCODING::End_type);
        ...
        //ITU_T_ARCHIVE_X691_DECL(START_DATE_TIME_DURATION_INTERVAL_ENCODING::Start_type);
        ...
        //ITU_T_ARCHIVE_X691_DECL(DURATION_END_DATE_TIME_INTERVAL_ENCODING::End_type);
        ...
        //ITU_T_ARCHIVE_X691_DECL(REC_START_END_DATE_TIME_INTERVAL_ENCODING::Start_type);
        //ITU_T_ARCHIVE_X691_DECL(REC_START_END_DATE_TIME_INTERVAL_ENCODING::End_type);
        ...
        //ITU_T_ARCHIVE_X691_DECL(REC_START_DATE_TIME_DURATION_INTERVAL_ENCODING::Start_type);
        ...
        //ITU_T_ARCHIVE_X691_DECL(REC_DURATION_END_DATE_TIME_INTERVAL_ENCODING::End_type);
