...
namespace ISO8823_PRESENTATION {
    ...
    struct PDV_list {
        ...
        BOOST_ASN_VALUE_HOLDERN_DECL(presentation_context_identifier, Presentation_context_identifier);
        BOOST_ASN_VALUE_HOLDERN_DECL(presentation_data_values, presentation_data_values_type);
    ...
    private:
        ...
        Presentation_context_identifier presentation_context_identifier_;
        presentation_data_values_type presentation_data_values_;
    };
    ...
    struct Result_list_sequence_of {
        ...
        BOOST_ASN_VALUE_HOLDERN_DECL(result, Result);
        BOOST_ASN_VALUE_OPTIONAL_DECL(transfer_syntax_name, Transfer_syntax_name);
    ...
    struct Presentation_context_identifier_list_sequence_of {
        ...
        BOOST_ASN_VALUE_HOLDERN_DECL(presentation_context_identifier, Presentation_context_identifier);
        BOOST_ASN_VALUE_HOLDERN_DECL(transfer_syntax_name, Transfer_syntax_name);
    ...
    struct Mode_selector {
        ...
        BOOST_ASN_VALUE_HOLDERN_DECL(mode_value, int);
    ...
    struct Default_context_name {
        ...
        BOOST_ASN_VALUE_HOLDERN_DECL(abstract_syntax_name, Abstract_syntax_name);
        BOOST_ASN_VALUE_HOLDERN_DECL(transfer_syntax_name, Transfer_syntax_name);
    ...
    private:
        ...
        Abstract_syntax_name abstract_syntax_name_;
        Transfer_syntax_name transfer_syntax_name_;
    };
    ...
    struct Context_list_sequence_of {
        ...
        BOOST_ASN_VALUE_HOLDERN_DECL(presentation_context_identifier, Presentation_context_identifier);
        BOOST_ASN_VALUE_HOLDERN_DECL(abstract_syntax_name, Abstract_syntax_name);
        BOOST_ASN_VALUE_HOLDERN_DECL(transfer_syntax_name_list, transfer_syntax_name_list_type);
    ...
    private:
        ...
        Presentation_context_identifier presentation_context_identifier_;
        Abstract_syntax_name abstract_syntax_name_;
        transfer_syntax_name_list_type transfer_syntax_name_list_;
    };
    ...
    struct CPA_PPDU {
        ...
        struct x410_mode_parameters_type {
            ...
            BOOST_ASN_VALUE_HOLDERN_DECL(connectionDataAC, Reliable_Transfer_APDU::ConnectionData);
        ...
        private:
            ...
            Reliable_Transfer_APDU::ConnectionData connectionDataAC_;
        };
        ...
        BOOST_ASN_VALUE_HOLDERN_DECL(mode_selector, Mode_selector);
    ...
    struct CP_type {
        ...
        struct x410_mode_parameters_type {
            ...
            BOOST_ASN_VALUE_HOLDERN_DECL(connectionDataRQ, Reliable_Transfer_APDU::ConnectionData);
        ...
        private:
            ...
            Reliable_Transfer_APDU::ConnectionData connectionDataRQ_;
