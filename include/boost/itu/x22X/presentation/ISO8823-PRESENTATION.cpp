...
namespace ISO8823_PRESENTATION {
    ...
    CP_type::X410_mode_parameters_type::X410_mode_parameters_type(shared_ptr< int> arg__checkpointSize,
    ...
    ITU_T_DEFAULTH_DEFN(CP_type::X410_mode_parameters_type::checkpointSize, checkpointSize, int);
    ITU_T_DEFAULTH_DEFN(CP_type::X410_mode_parameters_type::windowSize, windowSize, int);
    ITU_T_DEFAULTH_DEFN(CP_type::X410_mode_parameters_type::dialogueMode, dialogueMode, int);
    ...
    ITU_T_OPTIONAL_DEFN(CP_type::X410_mode_parameters_type::applicationProtocol, applicationProtocol, int);
    ...
    CPA_PPDU::X410_mode_parameters_type::X410_mode_parameters_type(shared_ptr< int> arg__checkpointSize,
            shared_ptr< int> arg__windowSize,
    ...
    ITU_T_DEFAULTH_DEFN(CPA_PPDU::X410_mode_parameters_type::checkpointSize, checkpointSize, int);
    ITU_T_DEFAULTH_DEFN(CPA_PPDU::X410_mode_parameters_type::windowSize, windowSize, int);
    ...
    ITU_T_HOLDERH_DEFN(Mode_selector::mode_value, mode_value, int);
    ...
    ITU_T_OPTIONAL_DEFN(Result_list_sequence_of::provider_reason, provider_reason, int);
