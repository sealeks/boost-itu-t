...
namespace Remote_Operations_Generic_ROS_PDUs {
    ...
    Reject::Reject(const InvokeId&  __invokeId,
        ...
        InvokeId& Reject::invokeId(){ return invokeId_ ;}

        void Reject::invokeId( const InvokeId& vl){ invokeId_ =vl ;}


        Reject::problem_type& Reject::problem(){ return problem_ ;}

        void Reject::problem( const problem_type& vl){ problem_ =vl ;}
