...
LDLIBSOPTIONS=-L../../../lib/${CND_CONF} -L../../../lib/boost/${CND_CONF} -lboost_itu_t -lboost_date_time -lboost_system -lboost_thread -lboost_chrono -lole32 -lwsock32 -loleaut32 -lws2_32 -lstdc++
...
${OBJECTDIR}/_ext/562270760/Test1.o: ../../../include_programs/test_asn1/Test1.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/562270760/Test1.o ../../../include_programs/test_asn1/Test1.cpp

${OBJECTDIR}/_ext/562270760/main.o: ../../../include_programs/test_asn1/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/562270760
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/562270760/main.o ../../../include_programs/test_asn1/main.cpp
