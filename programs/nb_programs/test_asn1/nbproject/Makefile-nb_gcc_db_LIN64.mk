...
${OBJECTDIR}/_ext/562270760/Test1.o: ../../../include_programs/test_asn1/Test1.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/562270760/Test1.o ../../../include_programs/test_asn1/Test1.cpp

${OBJECTDIR}/_ext/562270760/main.o: ../../../include_programs/test_asn1/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/562270760
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/562270760/main.o ../../../include_programs/test_asn1/main.cpp
