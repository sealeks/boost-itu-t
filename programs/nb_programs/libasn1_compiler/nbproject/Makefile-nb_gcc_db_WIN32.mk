...
${OBJECTDIR}/_ext/787997029/assignments.o: ../../../include/boost/itu/x68X/assignments.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/787997029
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DITUX200_DEBUG -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/787997029/assignments.o ../../../include/boost/itu/x68X/assignments.cpp

${OBJECTDIR}/_ext/787997029/constraint_templates.o: ../../../include/boost/itu/x68X/constraint_templates.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/787997029
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DITUX200_DEBUG -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/787997029/constraint_templates.o ../../../include/boost/itu/x68X/constraint_templates.cpp

${OBJECTDIR}/_ext/787997029/cpp_cout.o: ../../../include/boost/itu/x68X/cpp_cout.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/787997029
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DITUX200_DEBUG -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/787997029/cpp_cout.o ../../../include/boost/itu/x68X/cpp_cout.cpp
