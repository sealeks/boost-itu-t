...
${OBJECTDIR}/_ext/1313081326/main.o: ../../../include_programs/test_compiler/main.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DITUX200_DEBUG -I../../../include -I${BOOST_DIR} -mthreads -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1313081326/main.o ../../../include_programs/test_compiler/main.cpp
