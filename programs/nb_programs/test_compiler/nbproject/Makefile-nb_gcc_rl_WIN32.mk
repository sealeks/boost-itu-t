...
LDLIBSOPTIONS=-L../../../lib/${CND_CONF} -L../../../lib/boost/${CND_CONF} -lasn1_compiler -lboost_date_time -lboost_system -lboost_thread -lboost_chrono -lole32 -lwsock32 -loleaut32 -lws2_32
...
${OBJECTDIR}/_ext/1313081326/main.o: ../../../include_programs/test_compiler/main.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include -I${BOOST_DIR} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1313081326/main.o ../../../include_programs/test_compiler/main.cpp
