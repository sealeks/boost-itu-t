...
${OBJECTDIR}/_ext/467100861/ISO-9506-MMS-1.o: ../../../include/mms/ISO-9506-MMS-1.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/467100861/ISO-9506-MMS-1.o ../../../include/mms/ISO-9506-MMS-1.cpp

${OBJECTDIR}/_ext/467100861/ISO-9506-MMS-1A.o: ../../../include/mms/ISO-9506-MMS-1A.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/467100861
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/467100861/ISO-9506-MMS-1A.o ../../../include/mms/ISO-9506-MMS-1A.cpp

${OBJECTDIR}/_ext/467100861/MMS-Environment-1.o: ../../../include/mms/MMS-Environment-1.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/467100861
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/467100861/MMS-Environment-1.o ../../../include/mms/MMS-Environment-1.cpp

${OBJECTDIR}/_ext/467100861/MMS-Object-Module-1.o: ../../../include/mms/MMS-Object-Module-1.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/467100861
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/467100861/MMS-Object-Module-1.o ../../../include/mms/MMS-Object-Module-1.cpp
...
${OBJECTDIR}/_ext/467100861/mmssocket.o: ../../../include/mms/mmssocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/467100861
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -D_WIN32_WINNT=0x0601 -I../../../include -I${BOOST_DIR} -mthreads -fno-strict-aliasing -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/467100861/mmssocket.o ../../../include/mms/mmssocket.cpp
